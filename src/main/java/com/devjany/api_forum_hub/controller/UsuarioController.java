...
import com.devjany.api_forum_hub.domain.perfil.PerfilRepository;
import com.devjany.api_forum_hub.domain.usuario.*;
...
public class UsuarioController {
    ...
    public ResponseEntity cadastrar(@RequestBody @Valid DadosCadastroUsuario dados, UriComponentsBuilder uriBuilder) {
        ...
        var usuario = new Usuario(dadosComSenhaCriptografada, perfis);
